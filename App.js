...
export const guestsData = [
  { id: '1', name: 'Jhannel Quisuirin', address: 'Canada' },
  { id: '2', name: 'Miarafe Betasa', address: 'Israel' },
  { id: '3', name: 'Marie Therese Jaum', address: 'Singapore ' },
  { id: '4', name: 'Jenmarie Cumahig', address: 'USA' },
  { id: '5', name: 'Floramae Requillo', address: 'Thailand' },
  { id: '6', name: 'Riza Batulanon', address: 'India' },
  { id: '7', name: 'Monaliza Liparto', address: 'Philippines' },
